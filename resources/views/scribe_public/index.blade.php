...
<head>
    ...
    <title>API de SATIA - Publica</title>

    <link href="https://fonts.googleapis.com/css?family=PT+Sans&display=swap" rel="stylesheet">

    <link rel="stylesheet" href="{{ asset("/vendor/scribe_public/css/theme-elements.style.css") }}" media="screen">
    ...
    <script type="module">
        ...
        <script src="{{ asset("/vendor/scribe_public/js/tryitout-4.31.0.js") }}"></script>
        <style>
...
<div class="sl-elements sl-antialiased sl-h-full sl-text-base sl-font-ui sl-text-body sl-flex sl-inset-0">
    ...
    <div class="sl-flex sl-items-center sl-mb-5 sl-ml-4">
                ...
                <img src="https://satia-dev.s3.amazonaws.com/default/soluciones.png" height="30px" width="30px" alt="logo">
            </div>
                <h4 class="sl-text-paragraph sl-leading-snug sl-font-prose sl-font-semibold sl-text-heading">
            API de SATIA - Publica
        </h4>
    </div>
                        ...
                        <div title="Authenticating requests" id="toc-item-authenticating-requests"
                            ...
                            <a href="#authenticating-requests"
                               class="sl-flex-1 sl-items-center sl-truncate sl-mr-1.5 sl-p-0">Authenticating requests</a>
                                    ...
                                    <div class="expandable">
                        <div title="Guest" id="toc-item-guest"
                             class="sl-flex sl-items-center sl-h-md sl-pr-4 sl-pl-4 sl-bg-canvas-100 hover:sl-bg-canvas-200 sl-cursor-pointer sl-select-none">
                            <a href="#guest"
                               class="sl-flex-1 sl-items-center sl-truncate sl-mr-1.5 sl-p-0">Guest</a>
                                    ...
                                    <svg aria-hidden="true" focusable="false" data-prefix="fas"
                                        ...
                                        <div class="sl-flex sl-items-center sl-h-md sl-pr-4 sl-pl-8 sl-bg-canvas-100 hover:sl-bg-canvas-200 sl-cursor-pointer sl-select-none"
                                             id="toc-item-guest-GETapi-v1-public-guest-calculateConsumption">
                                            <div class="sl-flex-1 sl-items-center sl-truncate sl-mr-1.5 sl-p-0" title="Public Calculate Consumption">
                                                <a class="ElementsTableOfContentsItem sl-block sl-no-underline"
                                                   href="#guest-GETapi-v1-public-guest-calculateConsumption">
                                                    Public Calculate Consumption
                                                </a>
                                            </div>
                                                                                    </div>
            ...
            <div class="sl-mb-4">
                <h1 class="sl-text-5xl sl-leading-tight sl-font-prose sl-font-semibold sl-text-heading">
                    API de SATIA - Publica
                       ...
                       href="{{ route("scribe_public.postman") }}" target="_blank">
                        <small>Postman collection →</small>
                    </a>
                                                    <a title="Download OpenAPI spec" class="sl-mx-1"
                       href="{{ route("scribe_public.openapi") }}" target="_blank">
...
<p>Documentación de api de SATIA - Publica</p>
<aside>
    <strong>Base URL</strong>: <code>https://satiaserver.solucionesjmpf.com/</code>
</aside>
...
<p>You can retrieve your token by visiting your dashboard and clicking <b>Generate API token</b>.</p>
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--5 sl-flex sl-flex-col sl-items-stretch">
        <div class="sl-relative">
            <div class="sl-stack sl-stack--horizontal sl-stack--5 sl-flex sl-flex-row sl-items-center">
                <h2 class="sl-text-3xl sl-leading-tight sl-font-prose sl-text-heading sl-mt-5 sl-mb-1"
                    id="guest-GETapi-v1-public-guest-calculateConsumption">
                    Public Calculate Consumption
                </h2>
            </div>
        </div>
        ...
        <div class="sl-relative">
            <div title="https://satiaserver.solucionesjmpf.com/api/v1/public/guest/calculateConsumption"
                ...
                >
                        ...
                        <div dir="rtl"
                             class="sl-overflow-x-hidden sl-truncate sl-text-muted">https://satiaserver.solucionesjmpf.com</div>
                        <div class="sl-flex-1 sl-font-semibold">/api/v1/public/guest/calculateConsumption</div>
                    </div>
        ...
        <p>This endpoint is used to calculate consumption</p>
    </div>
    <div class="sl-flex">
    ...
    <div class="sl-overflow-y-hidden sl-rounded-lg">
        <form class="TryItPanel sl-bg-canvas-100 sl-rounded-lg"
              data-method="GET"
              data-path="api/v1/public/guest/calculateConsumption"
              data-hasfiles="0"
              data-hasjsonbody="0">
                    ...
                    <div class="sl-panel__content-wrapper sl-bg-canvas-100 children" role="region">
                        <div class="ParameterGrid sl-p-4">
                            <label aria-hidden="true"
                                   for="auth-GETapi-v1-public-guest-calculateConsumption">Authorization</label>
                            <span class="sl-mx-3">:</span>
                            <div class="sl-flex sl-flex-1">
                                <div class="sl-input sl-flex-1 sl-relative">
                                    <code>Bearer </code>
                                    <input aria-label="Authorization"
                                           id="auth-GETapi-v1-public-guest-calculateConsumption"
                    ...
                    <div class="sl-panel__content-wrapper sl-bg-canvas-100 children" role="region">
                        <div class="ParameterGrid sl-p-4">
                                                                                                                            <label aria-hidden="true"
                                       for="header-GETapi-v1-public-guest-calculateConsumption-Content-Type">Content-Type</label>
                                <span class="sl-mx-3">:</span>
                                <div class="sl-flex sl-flex-1">
                                    <div class="sl-input sl-flex-1 sl-relative">
                                        <input aria-label="Content-Type" name="Content-Type"
                                               id="header-GETapi-v1-public-guest-calculateConsumption-Content-Type"
                                               value="application/json" data-component="header"
                                               class="sl-relative sl-w-full sl-h-md sl-text-base sl-pr-2.5 sl-pl-2.5 sl-rounded sl-border-transparent hover:sl-border-input focus:sl-border-primary sl-border">
                                    </div>
                                </div>
                                                                                            <label aria-hidden="true"
                                       for="header-GETapi-v1-public-guest-calculateConsumption-Accept">Accept</label>
                                <span class="sl-mx-3">:</span>
                                <div class="sl-flex sl-flex-1">
                                    <div class="sl-input sl-flex-1 sl-relative">
                                        <input aria-label="Accept" name="Accept"
                                               id="header-GETapi-v1-public-guest-calculateConsumption-Accept"
                                               value="application/json" data-component="header"
                                               class="sl-relative sl-w-full sl-h-md sl-text-base sl-pr-2.5 sl-pl-2.5 sl-rounded sl-border-transparent hover:sl-border-input focus:sl-border-primary sl-border">
                                    </div>
                                </div>
            ...
            <div class="SendButtonHolder sl-mt-4 sl-p-4 sl-pt-0">
                <div class="sl-stack sl-stack--horizontal sl-stack--2 sl-flex sl-flex-row sl-items-center">
                    <button type="button" data-endpoint="GETapi-v1-public-guest-calculateConsumption"
            ...
            <div data-endpoint="GETapi-v1-public-guest-calculateConsumption"
...
You can check the Dev Tools console for debugging information.</p>
    ...
    --get "https://satiaserver.solucionesjmpf.com/api/v1/public/guest/calculateConsumption" \
    ...
    "https://satiaserver.solucionesjmpf.com/api/v1/public/guest/calculateConsumption"
);
...
$url = 'https://satiaserver.solucionesjmpf.com/api/v1/public/guest/calculateConsumption';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
                                    ...
                                    <div class="sl--ml-2">
                                        <div class="sl-h-sm sl-text-base sl-font-medium sl-px-1.5 sl-text-muted sl-rounded sl-border-transparent sl-border">
                                            ...
                                            <div class="sl-mb-2 sl-inline-block">
                                                <select
                                                        class="example-response-GETapi-v1-public-guest-calculateConsumption-toggle sl-text-base"
                                                        aria-label="Response sample"
                                                        onchange="switchExampleResponse('GETapi-v1-public-guest-calculateConsumption', event.target.value);">
                                        ...
                                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="copy"
                                            ...
                                            <path fill="currentColor"
                                                  d="M384 96L384 0h-112c-26.51 0-48 21.49-48 48v288c0 26.51 21.49 48 48 48H464c26.51 0 48-21.49 48-48V128h-95.1C398.4 128 384 113.6 384 96zM416 0v96h96L416 0zM192 352V128h-144c-26.51 0-48 21.49-48 48v288c0 26.51 21.49 48 48 48h192c26.51 0 48-21.49 48-48L288 416h-32C220.7 416 192 387.3 192 352z"></path>
                                                            ...
                                                            <div class="sl-panel__content-wrapper sl-bg-canvas-100 example-response-GETapi-v1-public-guest-calculateConsumption example-response-GETapi-v1-public-guest-calculateConsumption-0"
                                     style=" "
                                >
                                    <div class="sl-panel__content sl-p-0">                                                                                                                                
                                            <pre><code style="max-height: 300px;"
                                                       class="language-json sl-overflow-x-auto sl-overflow-y-auto">{
    &quot;message&quot;: &quot;Get calculate consumption&quot;
}</code></pre>
                                                                            </div>
                                </div>
                                                    </div>
